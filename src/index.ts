 ...
 * Implements the AIAgentProvider interface to manage Gemini sessions.
 * Uses the `gemini` CLI with `prompt` subcommand.
 */
...
export const vibePlugin: VibePlugin = {
  name: "gemini",
  version: "1.0.0",
  description: "Google Gemini AI agent provider for VibeControls",
